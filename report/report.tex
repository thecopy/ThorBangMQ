...
\begin{document}
    ...
    \section{Tests and results}
        ...
        \subsection{Difference is message size}
            % TODO: plot graphs for diff_clients_msgsize-10b, diff_clients_msgsize-1mb, diff_clients_msgsize-10mb
            %       with error bars
        ...
        \subsection{Difference in request frequency}
            % TODO: plot graphs for diff_sleep-time-between-requests
