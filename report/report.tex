   ...
   \begin{figure}[H]
    ...
    \section{Analysis}
        ...
        \subsection{Size of messages}
            We can see from Figure \ref{fig:responsetime_msgsize} that the size of a message only affects the time to perform \textit{Send message}. \textit{Pop message} and \textit{Peek message} seem unaffected by the size of the message. This is attributed to the implementation of the database and the conclusion can be drawn to say that the system handles big payloads well.
